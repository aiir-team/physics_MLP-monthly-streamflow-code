...
from models.main.hybrid_mlp import AsoMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import aso_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}-al_{}-bt_{}".format(N_RUNS,item["hidden_size"], item["activations"], item["epoch"], item["pop_size"],
    ...
    md = AsoMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, aso_paras=aso_paras)
    md._running__()
