#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:34, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import DeMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import de_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}-wf_{}-cr_{}".format(N_RUNS, item["hidden_size"], item["activations"],item["epoch"], item["pop_size"],
                                                                      item["wf"], item["cr"])
    root_hybrid_paras = {
    ...
    md = DeMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, de_paras=de_paras)
    md._running__()
