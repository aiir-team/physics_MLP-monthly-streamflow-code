#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:35, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import EoMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import eo_mlp_final as param_grid
...
def train_model(item):
    ...
    eo_paras = {"epoch": item["epoch"], "pop_size": item["pop_size"]}

    md = EoMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, eo_paras=eo_paras)
    md._running__()
