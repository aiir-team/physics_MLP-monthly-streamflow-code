#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:30, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import GaMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import ga_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}-pc_{}-pm_{}".format(N_RUNS, item["hidden_size"], item["activations"],item["epoch"], item["pop_size"],
                                                                   item["pc"], item["pm"])
    root_hybrid_paras = {
    ...
    md = GaMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, ga_paras=ga_paras)
    md._running__()
