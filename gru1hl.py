...
from models.main.traditional_rnn import Gru1HL
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import gru1hl_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ep_{}-bs_{}-lr_{}-ac_{}-op_{}-lo_{}-dr_{}".format(N_RUNS, item["hidden_sizes"], item["epoch"], item["batch_size"],
                                                            item["learning_rate"], item["activations"], item["optimizer"], item["loss"], item["dropouts"])
    root_rnn_paras = {
    ...
    md = Gru1HL(root_base_paras=root_base_paras, root_rnn_paras=root_rnn_paras)
    md._running__()
