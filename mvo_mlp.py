#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:36, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import MvoMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import mvo_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}-wep_minmax_{}".format(N_RUNS, item["hidden_size"], item["activations"], item["epoch"], item["pop_size"],
                                                                   item["wep_minmax"])
    root_hybrid_paras = {
    ...
    md = MvoMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, mvo_paras=mvo_paras)
    md._running__()
