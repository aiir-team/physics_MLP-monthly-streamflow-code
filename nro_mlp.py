#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 15:40, 30/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import NroMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import nro_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}".format(N_RUNS, item["hidden_size"], item["activations"], item["epoch"], item["pop_size"])
    root_hybrid_paras = {
    ...
    md = NroMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, nro_paras=nro_paras)
    md._running__()
