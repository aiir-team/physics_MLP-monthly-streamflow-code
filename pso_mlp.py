#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:37, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import PsoMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import pso_mlp_final as param_grid
...
def train_model(item):
    ...
    paras_name = "run_{}-hs_{}-ac_{}--ep_{}-ps_{}-c1_{}-c2_{}-w_min_{}-w_max_{}".format(N_RUNS, item["hidden_size"], item["activations"], item["epoch"],
                                                                item["pop_size"], item["c1"], item["c2"], item["w_min"], item["w_max"])
    root_hybrid_paras = {
    ...
    md = PsoMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, pso_paras=pso_paras)
    md._running__()
