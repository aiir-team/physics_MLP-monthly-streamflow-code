#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 20:15, 25/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_rnn import GaRnn
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import ga_rnn_final as param_grid
...
def train_model(item):
	...
	md = GaRnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, ga_paras=ga_paras)
	md._running__()
