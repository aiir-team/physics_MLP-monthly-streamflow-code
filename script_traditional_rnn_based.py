...
tf.config.threading.set_intra_op_parallelism_threads(4)  # matrix multiplication and reductions
tf.config.threading.set_inter_op_parallelism_threads(4)  # number of threads used by independent non-blocking operations
