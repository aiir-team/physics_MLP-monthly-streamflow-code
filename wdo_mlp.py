#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:38, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import WdoMlp
...
def train_model(item):
    ...
    md = WdoMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, wdo_paras=wdo_paras)
    md._running__()
