#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 17:39, 27/03/2020                                                        %
#                                                                                                       %
...
from models.main.hybrid_mlp import WoaMlp
from utils.IOUtil import _load_dataset__
from utils.Settings import *
from utils.Settings import woa_mlp_final as param_grid
...
def train_model(item):
    ...
    woa_paras = {"epoch": item["epoch"], "pop_size": item["pop_size"]}

    md = WoaMlp(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, woa_paras=woa_paras)
    md._running__()
